...
namespace Pulumi.Lxd
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Lxd.version.txt");
    ...
    internal sealed class LxdResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public LxdResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
